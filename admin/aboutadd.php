...
if (isset($_POST['addabout'])) {
    ...
    //je fais moi-même les vérifications d'envoi


    move_uploaded_file($temp_name1, "upload/$aimage");

    $sql = "INSERT INTO about (title, content, image) 
				   VALUES ('$title', '$content', '$aimage')";

    $result = mysqli_query($con, $sql);

    if ($result) {
        $msg = '<div class="alert alert-success">
					<strong>Well done!</strong> You successfully added a new about.
				</div>';
    } else {
