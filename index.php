                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="tab-content mt-4" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" id="tabpanel"
                                                    ...
                                                    <div class="featured-thumb-data shadow-one">
                                                        ...
                                                        <div class="p-4 d-inline-block w-100">
                                                            <div class="float-left text-capitalize"><i
                                                                    class="fas fa-user text-primary mr-1"></i>By : <?php echo $row['uname']; ?></div>
                        ...
                        <div class="col-md-12 col-lg-6">
                            <div class="living-list pr-4">
                                ...
                                <ul>
                                    <li class="mb-4 text-white d-flex">
                                        ...
                                        <div class="pl-2">
                                            ...
                                            <p>Ad non vivamus Elementum eget fringilla venenatis quisque, maecenas
                                                adipiscing aliquet justo. Libero. Gravida. Sapien, dolor nostra sem.
                                                Rutrum conubia inceptos egestas dolor class.</p>
                                        </div>
                                    </li>
                                    <li class="mb-4 text-white d-flex">
                                    ...
                                    <li class="mb-4 text-white d-flex">
                                        <i class="flaticon-seller flat-medium float-left d-table mr-4 text-primary"
                                            aria-hidden="true"></i>
                                        <div class="pl-2">
                                            <h5 class="mb-3">Experience Quality</h5>
                                            <p>Ad non vivamus Elementum eget fringilla venenatis quisque, maecenas
...
while ($row = mysqli_fetch_array($query)) {
    echo '<div class="count-num text-primary my-4" data-speed="3000" data-stop="' . $row[0] . '">0</div>';
}
?>
...
?>
                                    <div class="text-white h5">Sale Property</div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="count wow text-center mb-sm-50" data-wow-duration="300">
...
?>
                                    <div class="text-white h5">Saved Users</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-12">
                            <div class="content-sidebar p-4">
                                <div class="mb-3 col-lg-12">
                                    <h4 class="double-down-line-left text-ordinary position-relative pb-4 mb-4">
                                        Testimonial</h4>
